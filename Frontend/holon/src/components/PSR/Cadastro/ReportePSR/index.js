			...
			<div className="PSR-Main">
				...
				<div className="PSR-Content">
					...
					<form onSubmit={this.handleSubmit} className="report-form">
						<div>
							<text>Endereço</text>
							<input className="Report-input" name="Endereco" onChange={this.handleChange} type="text" />
						</div>

						<div>
							<text>Bairro</text>
							<input className="Report-input" name="Bairro" onChange={this.handleChange} type="text" />
						</div>

						<div>
							<text>Cidade</text>
							<input className="Report-input" name="Cidade" onChange={this.handleChange} type="text" />
						</div>
